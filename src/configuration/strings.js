  ...
  en: {
    translation: {
      ...
      ItemDetails: {
        ...
        NoNameError: "Please provide a name!",
        NoPriceError: "Please provide a price!",
        QuantityLabel: "#",
        ResourceIsRequired: "Required by an Item!",
      ...
      Profile: {
        ApiError: "Unable to save this profile...\nSomething seems wrong...",
        Title: "User Profile",
        HeaderTitle: "User Profile",
        HelpText: "Update your details here.",
        InvalidFirstName: "First name invalid!",
        InvalidLastName: "Last name invalid!",
        SaveAction: "Saved",
        FirstNameDetails: "What's your first name?",
        LastNameDetails: "And your last name?",
